...
public class FlightAgentConfig {
    ...
    @Bean("flightRequestHandler")
    public RequestHandler hotelRequestHandler(
            @Qualifier("flightAgentExecutor") AgentExecutor flightAgentExecutor,
            TaskStore taskStore,
